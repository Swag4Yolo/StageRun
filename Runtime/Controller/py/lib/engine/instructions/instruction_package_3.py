...
class InstructPack3_P2Table(BaseTable):
    """
    ...
    # def initialize_pad_ni(self, ni=INSTRUCTION_FINISH, pkt_id=[DISABLED, DISABLED], cm=[DISABLED, DISABLED], cval=[DISABLED, DISABLED], cm_2 = [DISABLED, DISABLED], cval_2 = [DISABLED, DISABLED], 
    ...
    def arith_between_vars_v1_v2(self, program_id=1,ni=INSTRUCTION_FINISH, pkt_id=[DISABLED, DISABLED], cm=[DISABLED, DISABLED], cval=[DISABLED, DISABLED], cm_2 = [DISABLED, DISABLED], cval_2 = [DISABLED, DISABLED],
        ...
        keys = ExecutionTableKeys(program_id, ni, pkt_id, cm, cval, cm_2, cval_2)
