...
class SystemApp(BRIPipeline):
    ...
    def install(self, PFromExternal, PToExternal, PFromInternal, PToInternal, target_hw):
        self._init_configs_()
        ...
        self.pre_filter_mechanism.set_pkt_id(original_ig_port=[original_port, MASK_PORT], pkt_id=pkt_id, ni_f1=ni_f1, ni_f2=ni_f2,
                                            ipv4_dst_addr=[ROUTER_A_IP, ROUTER_A_MASK])
        ...
        self.pre_filter_mechanism.set_pkt_id(original_ig_port=[original_port, MASK_PORT], pkt_id=pkt_id, ni_f1=ni_f1, ni_f2=ni_f2,
                                             ipv4_dst_addr=[ROUTER_B_IP, ROUTER_B_MASK])
        ...
        self.f1.i1_p1.fetch_ipv4_ttl(ni=current_instr, pkt_id=[pkt_id, MASK_PKT_ID])

        self.f1.i1_p2.sum_ni(ni=current_instr, pkt_id=[pkt_id, MASK_PKT_ID], instr_id=next_instruct, header_update=1, header_id=HEADER_IPV4_TTL, const_val=1)
