...
class PosFilterKeys(BaseTableKeys):
    ...
    def from_key_dict(cls, key_dict):
        return cls(
            ...
            f1_mark_to_drop=[
                key_dict['res_md_f1.mark_to_drop']['value'],
                key_dict['res_md_f1.mark_to_drop']['mask']
            ],
            f2_mark_to_drop=[
                key_dict['res_md_f2.mark_to_drop']['value'],
                key_dict['res_md_f2.mark_to_drop']['mask']
            ],
            need_recirc=[
                key_dict['hdr.bridge_meta.need_recirc']['value'],
                key_dict['hdr.bridge_meta.need_recirc']['mask']
            ],
            fwd_and_enqueue=[
                key_dict['hdr.bridge_meta.fwd_and_enqueue']['value'],
                key_dict['hdr.bridge_meta.fwd_and_enqueue']['mask']
            ],
            rts=[
                key_dict['hdr.bridge_meta.rts']['value'],
            ...
            ipv4_proto=[
                key_dict['ig_md.keys.ipv4_protocol']['value'],
                key_dict['ig_md.keys.ipv4_protocol']['mask']
            ],
            program_id=[
                key_dict['hdr.bridge_meta.program_id']['value'],
                key_dict['hdr.bridge_meta.program_id']['mask']
            ],
        )
